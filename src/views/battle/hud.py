...
class HUD(Layer):
    ...
    def __init__(self):
        ...
        self._level_txt = cocos.sprite.Sprite('battle/hud/level.png')
        ...
        self._hp_bar = cocos.sprite.Sprite('battle/hud/hp_bar.png')
        self._hp_bar.position = 444, 218
        self.add(self._hp_bar)

        self._hp_bar_content = []
        for i in range(48):
            self._hp_bar_content.append(cocos.sprite.Sprite('battle/hud/hp_bar_green.png'))
        ...
        self._xp_bar = cocos.sprite.Sprite('battle/hud/xp_bar.png')
        self._xp_bar.position = 435, 195
        self.add(self._xp_bar)

        self._xp_bar_content = []
        for i in range(20):
            self._xp_bar_content.append(cocos.sprite.Sprite('battle/hud/xp_bar_blue.png'))
